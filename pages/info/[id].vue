            ...
            <div class="titles">
                <div class="info">
                    ...
                    <div class="genre-season">
                        <div class="genres">
                            <span class="genre" v-for="genre in data.genres.slice(0, 7)" :key="genre">{{ genre }}</span>
                        </div>
				...
				<div class="rating-container">
					...
					<span class="average-rating">{{ (data.averageRating).toFixed(0) }}/10</span>
				</div>
                ...
                <div class="description">
                    ...
                    <span class="showMoreLess" v-if="data.description.length > 500" @click="showDesc = !showDesc">{{
